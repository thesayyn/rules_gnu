...
# By default all these toolchains are registered by the gnu_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:gnu_toolchain",
    toolchain_type = "@rules_gnu//gnu:toolchain_type",
)
""".format(
            platform = platform,

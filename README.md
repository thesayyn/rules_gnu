...
1. search for "thesayyn" and replace with GitHub org
1. search for "gnu" and replace with the language/tool your rules are for
1. rename directory "gnu" similarly
...
<https://github.com/thesayyn/rules_gnu/releases>
...
1. Replace `strip_prefix = "rules_gnu-0.1.0"` with `strip_prefix = "rules_gnu-abc123"`
